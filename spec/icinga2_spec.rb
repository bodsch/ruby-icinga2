...
#    end
#
#    it 'add hostgroup \'spec-test\'' do
#      r = @icinga2.add_hostgroup( host_group: 'spec-test', display_name: 'Spec Test' )
#      expect(r).to be_a(Hash)
#      code = r['code']
#      expect(code).to be_a(Integer)
#      expect(code).to be 200
#    end
#
#    it 'exists hostgroup \'spec-test\'' do
#      expect(@icinga2.exists_hostgroup?('spec-test')).to be_truthy
#    end
#
#    it 'add hostgroup \'spec-test\'' do
#      r = @icinga2.delete_hostgroup( host_group: 'spec-test' )
#      expect(r).to be_a(Hash)
#      code = r['code']
#      expect(code).to be_a(Integer)
#      expect(code).to be 200
...
#    end
#
#    it "disable notification for host 'c1-mysql-1'" do
#      h = @icinga2.disable_host_notification( 'c1-mysql-1' )
#      status_code = h[:status]
#      expect(h).to be_a(Hash)
#      expect(status_code).to be == 200
#    end
